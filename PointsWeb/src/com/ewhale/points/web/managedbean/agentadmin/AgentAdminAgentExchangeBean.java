...
@SessionScoped
@ManagedBean
public class AgentAdminAgentExchangeBean extends PointsExchangeBean
{
	/**
	 * 
	 */
	...
	public void getAgentExchangesList()
	{
		...
		data.put(EntityConstants.PointsExchange.agentId, FacesUtil.getLoginAgentId());
	...
	public void viewDetails(Map<String, Object> data, String selectedField)
	{
		...
		{
			AgentAdminAgentBranchBean agentAdminAgentBranchBean = FacesUtil.getObjectFromSession(AgentAdminAgentBranchBean.class, true);
			agentAdminAgentBranchBean.viewDetails((Map<String, Object>) data.get(EntityConstants.PointsExchange.branch));
		}
		else if (selectedField.equals(EntityConstants.Product.productName))
		{
			AgentAdminAgentProductBean agentAdminAgentProductBean = FacesUtil.getObjectFromSession(AgentAdminAgentProductBean.class, true);
			agentAdminAgentProductBean.viewDetails((Map<String, Object>) data.get(EntityConstants.PointsExchange.product));
		}
	}
